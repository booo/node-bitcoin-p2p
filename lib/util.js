...
var sha1 = exports.sha1 = function (data) {
  return new Buffer(crypto.createHash('sha').update(data).digest('binary'), 'binary');
};
...
var verifySig = exports.verifySig = ccmodule.verify_sig;
...
var valueToBigInt = exports.bigIntToValue = function (valueBigInt) {
  if (valueBigInt instanceof Buffer) {
    return valueBigInt;
  }

...
Settings.prototype.setLivenetDefaults = function () {
	...
	this.network.proofOfWorkLimit = new Buffer("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff", "hex");
};
...
Settings.prototype.setUnitnetDefaults = function () {
	...
	this.network.magicBytes = new Buffer('f3bbb2df', 'hex');
	this.network.bootstrap = [];

	this.network.proofOfWorkLimit = new Buffer("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", "hex");

	this.network.genesisBlock.hash = new Buffer("14dae1db98ca7efa42cc9ebe7ebb19bd88d80d6cbd3c4a993c20b47401d238c6", "hex");
